...
def Resnet18(out_features=11, pretrained=True, grayscale=False):
...
def EfficientNetB0(out_features=11, grayscale=False):
    """Modifies the Resnet architecture for a greyscale image and specified number of output features."""
...
def Resnet50(out_features=11, pretrained=True, grayscale=False):
    """Modifies the Resnet architecture for a greyscale image and specified number of output features."""
...
def Resnet18_448(out_features=11, grayscale=False):
    """Modifies the Resnet architecture for a greyscale image and specified number of output features."""
    from torchvision.models import resnet18
    model = resnet18()
    if grayscale:
        ...
        model.conv1 = Conv2d(3, 64, kernel_size=(7, 7), stride=(4, 4), padding=(3, 3), bias=False)
    model.fc = Linear(in_features=512, out_features=out_features, bias=True)
    return model